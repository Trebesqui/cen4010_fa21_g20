                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col-sm-1 col-md-1">
                            <form action="/striker_prototype/checkout_1.php" method="POST">
                    ...
                    <tr>
                        ...
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"> <img class="media-object" src="assets/token.png" style="width: 72px; height: 72px;"> </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">5 Tokens</a></h4>
                        ...
                        <td class="col-sm-1 col-md-1">
                            <form action="/striker_prototype/checkout_2.php" method="POST">
                                <button type="submit" class="btn btn-success">
                                    <span class="glyphicon glyphicon-remove"></span> Checkout
                                </button>
                            </form>
                    ...
                    <tr>
                        ...
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"> <img class="media-object" src="assets/token.png" style="width: 72px; height: 72px;"> </a>
                            <div class="media-body">
                                <h4 class="media-heading"><a href="#">15 Tokens</a></h4>
                        ...
                        <td class="col-sm-1 col-md-1">
                            <form action="/striker_prototype/checkout_3.php" method="POST">
                                <button type="submit" class="btn btn-success">
                                    <span class="glyphicon glyphicon-remove"></span> Checkout
                                </button>
                            </form>
